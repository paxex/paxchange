...
SOURCES += src/activemasternode.cpp \
           ...
           src/core_write.cpp \
           src/crypter.cpp \
           src/paxchange-cli.cpp \
           src/paxchange-tx.cpp \
           src/paxchange.cpp \
           src/db.cpp \
           ...
           src/qt/paxchange.cpp \
           src/qt/paxchangestrings.cpp \
...
RESOURCES += src/qt/paxchange.qrc src/qt/paxchange_locale.qrc

TRANSLATIONS += src/qt/locale/paxchange_bg.ts \
                src/qt/locale/paxchange_de.ts \
                src/qt/locale/paxchange_en.ts \
                src/qt/locale/paxchange_es.ts \
                src/qt/locale/paxchange_fi.ts \
                src/qt/locale/paxchange_fr.ts \
                src/qt/locale/paxchange_it.ts \
                src/qt/locale/paxchange_ja.ts \
                src/qt/locale/paxchange_pl.ts \
                src/qt/locale/paxchange_pt.ts \
                src/qt/locale/paxchange_ru.ts \
                src/qt/locale/paxchange_sk.ts \
                src/qt/locale/paxchange_sv.ts \
                src/qt/locale/paxchange_vi.ts \
                src/qt/locale/paxchange_zh_CN.ts \
                src/qt/locale/paxchange_zh_TW.ts
