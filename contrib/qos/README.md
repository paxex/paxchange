...
This means one can have an always-on paxchanged instance running, and another local paxchanged/paxchange-qt instance which connects to this node and receives blocks from it.
