...
#   c) node1 mines 32 blocks, so now node 0 has 500000PAXEX, node 1 has 4250PAXEX, node2 has none.
#   d) node0 sends 601 PAXEX to node2, in two transactions (301 PAXEX, then 300 PAXEX).
