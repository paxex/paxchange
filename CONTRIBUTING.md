Contributing to PAXCHANGE Core
==================================

The PAXCHANGE Core project operates an open contributor model where anyone is
...
The following applies to code changes to the PAXCHANGE Core project, and is not to be
confused with overall PAXCHANGE Network Protocol consensus changes.

Whether a pull request is merged into PAXCHANGE Core rests with the project merge
...
Patches that change PAXCHANGE consensus rules are considerably more involved than
...
Where a patch set proposes to change the PAXCHANGE consensus, it must have been
...
The project leader is the release manager for each PAXCHANGE Core release.
