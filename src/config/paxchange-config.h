/* src/config/paxchange-config.h.  Generated from paxchange-config.h.in by configure.  */
/* src/config/paxchange-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef PAXEX_CONFIG_H

#define PAXEX_CONFIG_H
...
#define PACKAGE_NAME "PAXCHANGE Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "PAXCHANGE Core 2.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "paxchange"
