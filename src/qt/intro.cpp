...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("PAXCHANGE Core"),
     ...
     * override -datadir in the paxchange.conf file in the default data directory
     * (to be consistent with paxchanged behavior)
     */
    if (dataDir != getDefaultDataDirectory())
