                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("PAXCHANGE Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and paxchange: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About PAXCHANGE Core"), this);
    aboutAction->setStatusTip(tr("Show information about PAXCHANGE Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for PAXCHANGE"));
    ...
    openAction->setStatusTip(tr("Open a paxchange: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the PAXCHANGE Core help message to get a list with possible PAXCHANGE command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("PAXCHANGE Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to PAXCHANGE network", "", count));
}
...
{
    QString strTitle = tr("PAXCHANGE Core"); // default title
