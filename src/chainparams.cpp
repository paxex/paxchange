...
// Copyright (c) 2017 The PAXCHANGE developers
...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("0x000003d5d1c2bf0192fe956d7424539c44fcb797fd21dc5e2f1bcea42e1eee7e"));

static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1529652270, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 2 * 60; // PAXCHANGE: 1 day
        nTargetSpacing = 2 * 60;  // PAXCHANGE: 2 minutes
        nMaturity = 10;
        ...
        const char* pszTimestamp = "Even With Energy Surplus, Canada Unable to Meet Electricity Demands of Bitcoin Miners - PAXCHANGER";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1529652270;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 3366672;

        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x000003d5d1c2bf0192fe956d7424539c44fcb797fd21dc5e2f1bcea42e1eee7e"));
        assert(genesis.hashMerkleRoot == uint256("0x303059f672f8a95731609f36ce140ecadd11207c69ea6e8037b7a579831c26fd"));

        // DNS Seeding
        vSeeds.push_back(CDNSSeedData("167.99.88.119", "167.99.88.119"));
        vSeeds.push_back(CDNSSeedData("192.241.152.200", "192.241.152.200"));

        // PAXCHANGE addresses start with 'G'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 55);
        // PAXCHANGE script addresses start with '3'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 117);
        // PAXCHANGE private keys start with 'K'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 46);
        // PAXCHANGE BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x88)(0xB2)(0x1E).convert_to_container<std::vector<unsigned char> >();
        // PAXCHANGE BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x88)(0xAD)(0xE4).convert_to_container<std::vector<unsigned char> >();
        // PAXCHANGE BIP44 coin type is '222' (0x800000de)
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // PAXCHANGE: 1 day
        nTargetSpacing = 2 * 60;  // PAXCHANGE: 1 minute
        nLastPOWBlock = 200;
        nMaturity = 15;
        ...
        // Testnet PAXCHANGE addresses start with 'g'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 98);
        // Testnet PAXCHANGE script addresses start with '5' or '6'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 12);
        // Testnet private keys start with 'k'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 108);
        // Testnet PAXCHANGE BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Testnet PAXCHANGE BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // PAXCHANGE: 1 day
        nTargetSpacing = 2 * 60;        // PAXCHANGE: 1 minutes
        bnProofOfWorkLimit = ~uint256(0) >> 1;
        genesis.nTime = 1516926684;
