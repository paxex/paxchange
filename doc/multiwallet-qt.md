...
In order to support loading of multiple wallets in paxchange-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is paxchange.cpp.
...
Changes to paxchange.cpp
----------------------
paxchange.cpp is the entry point into paxchange-qt, and as such, will require some minor modifications to provide hooks for
