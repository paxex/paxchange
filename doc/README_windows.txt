...
Intro
-----
PAXCHANGE (PAXEX) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. PAXCHANGE utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run paxchange-qt.exe.

PAXCHANGE Core is the original PAXCHANGE client and it builds the backbone of the network.
However, it downloads and stores the entire history of PAXCHANGE transactions;
